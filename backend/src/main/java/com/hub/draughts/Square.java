...
public class Square {
    ...
    private static final int Corner_Dark = 0;
    ...
    public static boolean is_valid(int sq) {
        return sq >= 0
            && file(sq) < File_Size
            && rank(sq) < Rank_Size;
    }
    ...
    public static int from_std(int std) throws Bad_Input {
    ...
    public static int to_std(int sq) {
