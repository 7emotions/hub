...
public class FEN {
    ...
    public static Pos from_fen(String s) throws Bad_Input {
        ...
        NumberScanner scan = new NumberScanner(s);
    ...
    private static int parse_side(NumberScanner scan) throws Bad_Input {
    ...
    private static long[] parse_pieces(NumberScanner scan) throws Bad_Input {
